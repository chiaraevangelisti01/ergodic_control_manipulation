...
class ElectrostaticHalftoning:
    ...
    def __init__(self, num_agents, image_path,xdom, ydom, num_iterations = 250, target_resolution=(100, 100), displacement_threshold=1e-2):
    ...
    def evolve_particles(self):
        ...
        positions_over_time = []
        tau = 0.1#0.006  # Step size, reduce it for more fine-grained movement
